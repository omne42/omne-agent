...
pub struct ThreadCheckpointRestoreParams {
    pub thread_id: omne_agent_protocol::ThreadId,
    pub checkpoint_id: omne_agent_protocol::CheckpointId,
    #[serde(default)]
    #[ts(optional)]
    pub turn_id: Option<omne_agent_protocol::TurnId>,
    #[serde(default)]
...
pub struct ThreadConfigureParams {
    ...
    #[serde(default)]
    #[ts(optional)]
    pub approval_policy: Option<omne_agent_protocol::ApprovalPolicy>,
    #[serde(default)]
    #[ts(optional)]
    pub sandbox_policy: Option<omne_agent_protocol::SandboxPolicy>,
    #[serde(default)]
    #[ts(optional)]
    pub sandbox_writable_roots: Option<Vec<String>>,
    #[serde(default)]
    #[ts(optional)]
    pub sandbox_network_access: Option<omne_agent_protocol::SandboxNetworkAccess>,
    #[serde(default)]
    #[ts(optional)]
