...
mod auto_summary_tests {
    ...
    use omne_agent_protocol::TurnStatus;
    use tokio::sync::broadcast;

    fn build_test_server(agent_root: PathBuf) -> crate::Server {
    ...
    async fn build_conversation_prefers_latest_summary_artifact() -> anyhow::Result<()> {
        ...
        thread_rt
            ...
            .await?;
        thread_rt
            .append_event(omne_agent_protocol::ThreadEventKind::AssistantMessage {
